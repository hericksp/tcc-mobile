...
class VisitantesSind : AppCompatActivity() {
    ...
    private fun listarVisitantes(){
        ...
        val  call: Call<List<Visitas>> = remote.ListarVisitasSind()
        call.enqueue(object : Callback<List<Visitas>>{
            ...
            override fun onFailure(call: Call<List<Visitas>>, t: Throwable) {
                Toast.makeText(this@VisitantesSind, "Algo deu errado", Toast.LENGTH_LONG).show()
